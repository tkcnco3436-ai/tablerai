...
export default function ProposalContent() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-14">
      ...
      <section className="mt-16">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {steps.map((s) => (
            ...
            >
              <div className="mb-3 text-sm font-bold text-blue-600">{s.step}</div>
      ...
      {/* Contact CTA */}
      <section className="mt-16 rounded-3xl border border-slate-200 bg-blue-50 p-10 text-center">
        ...
        <a
          ...
          className="mt-7 inline-block rounded-xl bg-blue-500 px-7 py-3.5 font-semibold text-white transition hover:bg-blue-600 active:scale-[0.98]"
        >
